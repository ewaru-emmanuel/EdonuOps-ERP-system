#!/usr/bin/env python3
"""
Debug the company joining function
"""
...
def debug_company_joining():
    """Debug the company joining function"""
    try:
        print("🔍 Debugging company joining function...")
        ...
        with app.app_context():
            ...
            # Check if we can create a tenant
            from modules.core.tenant_models import Tenant
            import uuid
...
if __name__ == "__main__":
    success = debug_company_joining()
    if success:
        print("\n🎉 Company joining function works!")
    else:
        print("\n❌ Company joining function has issues!")
